...
public class Principal {
	...
	public static void main(String[] args) {
		...
		filtrarPrecio(lista, listaFiltrada);
		
		//filtrarPaginas(lista, listaFiltrada);
	...
	private static void filtrarPrecio(List<Libro> lista, List<Libro> listaFiltrada) {
		for(Libro l: lista) {
			if(l.getPrecio() > 20) {
				listaFiltrada.add(l);
			}
	...
	private static void filtrarPaginas(List<Libro> lista, List<Libro> listaFiltrada) {
		for(Libro l: lista) {
			if(l.getPaginas() > 400) {
				listaFiltrada.add(l);
			}
